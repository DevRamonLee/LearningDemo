...
public class ImageCache {
    ...
    protected void init() {
        ...
        mMemoryCache = new LruCache<String, BitmapDrawable>(MAX_MEMORY) {
            ...
            protected void entryRemoved(boolean evicted, String key,
                ...
                if (hasHoneycomb()) {
                    Log.e("RamonLee","mReusableBitmaps add");
    ...
    /**
     * 从 mReusableBitmaps 中获取满足能设置到 BitmapFactory.Options.inBitmap 上面的 Bitmap 对象
     * @param options
     * @return
     */
    ...
    public static boolean canUseForInBitmap(Bitmap candidate,
        ...
        // 在Anroid4.4以后，如果要使用inBitmap的话，只需要解码的Bitmap比 inBitmap 设置的小就行了，对 inSampleSize 没有限制
