...
public class ZoomActivity extends AppCompatActivity {
    ...
    private void zoomImageFromThumb(final View thumbView, int imageResId) {
        ...
        Log.i("meng", " startBounds: " + startBounds);  // startBounds: Rect(48, 288 - 348, 513) 打印顺序为 left top right bottom

        // globalOffset 代表视图在屏幕中的偏移量
        findViewById(R.id.container)
                .getGlobalVisibleRect(finalBounds, globalOffset);

        Log.i("meng", "finalBounds.left is " + finalBounds.left + " finalBounds.top is " + finalBounds.top + " globalOffset x is " + globalOffset.x + " globalOffset y is " + globalOffset.y);
