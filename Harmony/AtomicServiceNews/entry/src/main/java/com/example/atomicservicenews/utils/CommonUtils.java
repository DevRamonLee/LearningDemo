...
package com.example.atomicservicenews.utils;
...
public class CommonUtils {
     ...
     * @param first index
     * @param second  index
     * @param firstNews news
     * @param secondNews news
     * @return js page data
     */
    public static ZSONObject getJsBindData(int first, int second, NewsInfo firstNews, NewsInfo secondNews) {
        ZSONObject zsonObject = new ZSONObject();
        zsonObject.put("firstIndex", first);
        zsonObject.put("firstNewsTitle", firstNews.getTitle());
        zsonObject.put("firstNewsImgUrl", firstNews.getCardImgUrl());
        zsonObject.put("secondIndex", second);
        zsonObject.put("secondNewsTitle", secondNews.getTitle());
        zsonObject.put("secondNewsImgUrl", secondNews.getCardImgUrl());
        return zsonObject;
    }
}
